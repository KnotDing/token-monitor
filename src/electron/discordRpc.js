...
const KNOWN_CLIENT_ASSETS = new Set([
  ...
  'amp', 'droid', 'kimi', 'qwen', 'grok', 'copilot', 'gcmp', 'pi', 'zed', 'kilo', 'commandcode', 'micode', 'zcode', 'kiro', 'codebuddy', 'workbuddy', 'proma', 'qodercn', 'reasonix', 'dsh', 'cherrystudio', 'lmstudio', 'unsloth',
  'gemini'
]);
const CLIENT_LABELS = {
  ...
  gcmp: 'AI Chat Models', pi: 'Pi', zed: 'Zed', kilo: 'Kilo', commandcode: 'Command Code', micode: 'MiMo Code', zcode: 'ZCode', kiro: 'Kiro', codebuddy: 'CodeBuddy', workbuddy: 'WorkBuddy', proma: 'Proma', qodercn: 'Qoder CN', reasonix: 'Reasonix', dsh: 'DeepSeek Harness', cherrystudio: 'Cherry Studio', lmstudio: 'LM Studio', unsloth: 'Unsloth',
  gemini: 'Gemini'
};
